...
using UnityEditor;
using UnityEngine;
using Utils.Unity.Serialization;

namespace Utils.Unity.Editor.Serialization
{
    ...
    public class SerializePropertyAttributeDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (propertyFieldInfo == null)
                propertyFieldInfo = target.GetType().GetProperty(((SerializePropertyAttribute) attribute).PropertyName,
            ...
            GUIContent label)
        {
            switch (propertyType)
            {
                ...
                case SerializedPropertyType.Boolean:
                    ...
                    /* Unmerged change from project 'Utils.Unity.Serialization'
                    Before:
                    ...
                    */
                    ...
                    /* Unmerged change from project 'rotorz.unity3d-utils.editor'
                    Before:
                                    return EditorGUI.Toggle(position, label, (bool)value);
                                case SerializedPropertyType.Float:
                                    return EditorGUI.FloatField(position, label, (float)value);
                    ...
                    */
                    ...
                    /* Unmerged change from project 'Assembly-CSharp-Editor'
                    Before:
                                    return EditorGUI.Toggle(position, label, (bool)value);
                                case SerializedPropertyType.Float:
                                    return EditorGUI.FloatField(position, label, (float)value);
                    ...
                    */
                    ...
                    /* Unmerged change from project 'Utils.Unity.Editor'
                    Before:
                                    return EditorGUI.Toggle(position, label, (bool)value);
                                case SerializedPropertyType.Float:
                                    return EditorGUI.FloatField(position, label, (float)value);
                    ...
                    */
                    ...
                    /* Unmerged change from project 'rotorz.unity3d-editor-menu.editor'
                    Before:
                                    return EditorGUI.Toggle(position, label, (bool)value);
                                case SerializedPropertyType.Float:
                                    return EditorGUI.FloatField(position, label, (float)value);
                    ...
                    */
                    ...
                    /* Unmerged change from project 'rotorz.unity3d-package-utils.editor'
                    Before:
                                    return EditorGUI.Toggle(position, label, (bool)value);
                                case SerializedPropertyType.Float:
                                    return EditorGUI.FloatField(position, label, (float)value);
